        ...
        <div class="row py-5 border-bottom">
            ...
            <div class="col-xl-9 mb-3 pe-4 ps-4">
                <div class="fields_box row">
                    <H2>Chapter Pledge of Solidarity</H2>
                    <p style='line-height: 2; margin-top: 20px;'>&emsp;&emsp;By the power vested in us as the duly elected officers of the Grand Council of DSADA Chapter, we solemnly bind the Chapter and its members to bear true faith and allegiance to the Tenets and Code of Conduct, and to the Global Constitution, of the Tau Gamma Phi, and we solemnly swear to support and abide by the authority, policies and decisions of the Tau Gamma Phi Global leadership hierarchy.</p>
                            ...
                            <div class="col-xl-12 row text-center d-flex justify-content-center align-items-end mb-3" style="min-height: 120px;">
                                <div class="">
                                    ...
                                    <div class="signature_box d-flex d-none justify-content-center w-100"  data-signbox="gt">
                                        ...
                                        <textarea class="form-control field_monitor_multi d-none" name="signature[]" data-signbox="gt" data-fieldgroup_name="gt" data-fieldgroup_id="0">
                                            {{ getSignature("gt", $data) }}
                                        </textarea>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-12 row text-center d-flex justify-content-center align-items-end mb-3" style="min-height: 120px;">
                                <div class="">
                                    ...
                                    <div class="signature_box d-flex d-none justify-content-center w-100"  data-signbox="dgt">
                                        ...
                                        <textarea class="form-control field_monitor_multi d-none" name="signature[]" data-signbox="dgt" data-fieldgroup_name="dgt" data-fieldgroup_id="0">
                                            {{ getSignature("dgt", $data) }}
                                        </textarea>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-12 row text-center d-flex justify-content-center align-items-end mb-3" style="min-height: 120px;">
                                <div class="">
                                    ...
                                    <div class="signature_box d-flex d-none justify-content-center w-100"  data-signbox="mks">
                                        ...
                                        <textarea class="form-control field_monitor_multi d-none" name="signature[]" data-signbox="mks" data-fieldgroup_name="mks" data-fieldgroup_id="0">
                                            {{ getSignature("mks", $data) }}
                                        </textarea>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-12 row text-center d-flex justify-content-center align-items-end mb-3" style="min-height: 120px;">
                                <div class="">
                                    ...
                                    <div class="signature_box d-flex d-none justify-content-center w-100"  data-signbox="mkc">
                                        ...
                                        <textarea class="form-control field_monitor_multi d-none" name="signature[]" data-signbox="mkc" data-fieldgroup_name="mkc" data-fieldgroup_id="0">
                                            {{ getSignature("mkc", $data) }}
                                        </textarea>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-12 row text-center d-flex justify-content-center align-items-end mb-3" style="min-height: 120px;">
                                <div class="">
                                    ...
                                    <div class="signature_box d-flex d-none justify-content-center w-100"  data-signbox="mwww">
                                        ...
                                        <textarea class="form-control field_monitor_multi d-none" name="signature[]" data-signbox="mwww" data-fieldgroup_name="mwww" data-fieldgroup_id="0">
                                            {{ getSignature("mwww", $data) }}
                                        </textarea>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-12 row text-center d-flex justify-content-center align-items-end mb-3" style="min-height: 120px;">
                                <div class="">
                                    ...
                                    <div class="signature_box d-flex d-none justify-content-center w-100"  data-signbox="mi">
                                        ...
                                        <textarea class="form-control field_monitor_multi d-none" name="signature[]" data-signbox="mi" data-fieldgroup_name="mi" data-fieldgroup_id="0">
                                            {{ getSignature("mi", $data) }}
                                        </textarea>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-12 row text-center d-flex justify-content-center align-items-end mb-3" style="min-height: 120px;">
                                <div class="">
                                    ...
                                    <div class="signature_box d-flex d-none justify-content-center w-100"  data-signbox="information_certification">
                                        ...
                                        <textarea class="form-control field_monitor_multi d-none" name="signature[]" data-signbox="information_certification" data-fieldgroup_name="information_certification" data-fieldgroup_id="0">
                                            {{ getSignature("information_certification", $data) }}
                                        </textarea>
                                    </div>
                                </div>
...
<script>
    ...
    $(document).ready( function(){
        ...
        var signs = $(document).find(".ajax_form").find(".signature");

        $.each(signs, function(k, v){

            var signbox = $(v).attr("data-signbox");
            var target = $(document).find("textarea[data-signbox='" + signbox + "']");
