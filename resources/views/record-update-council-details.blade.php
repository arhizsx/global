...
@section("subheader")
    <div class="subheader-text">Council Details Update</div>
@endsection

@section("breadcrumbs")
<div class="trail"><a href="/">Home</a> > <a href="/record-update">Record Update</a> > <a href="/record-update/council">Council</a> > <strong>Details</strong></div>
@endsection
...
@if( \Auth::user()->serial_number != null || \Auth::user()->serial_number != "" )
    ...
    @php
        $json = "council-details-update.json";
    @endphp
    <form class="form ajax_update_form" id="council_details_update">
