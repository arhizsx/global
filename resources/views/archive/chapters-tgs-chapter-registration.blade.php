...
@section("breadcrumbs")
    <div class="trail"><a href="/">Home</a> > <a href="/chapters">Chapters</a> > <strong>TGS Chapter Registration</strong></div>
@endsection
...
<form class="form ajax_form" id="tgs_chapter_registration">
    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-end px-3 pt-3 pb-5">
            <button class="btn btn-dark ajax_btn me-3" data-action="tgs-chapter-registration-cancel">Cancel</button>
            <button class="btn btn-secondary ajax_btn" data-action="tgs-chapter-registration-continue">Submit My Registration</button>
        </div>
    </div>
</form>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #fdd700;">
                    <h5 class="modal-title" id="modallabel">TGS Chapter Registration</h5>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-sm btn-dark ajax_btn" data-action="tgs-chapter-registration-confirm">Confirm</button>
            </div>
        </div>
    </div>
</div>
