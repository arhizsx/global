...
@section("breadcrumbs")
    <div class="trail"><a href="/">Home</a> > <a href="/triskelions">Triskelions</a> > <strong>Lady Triskelion Registration</strong></div>
@endsection
...
@endphp
<form class="form ajax_form" id="lady_triskelion_registration">
