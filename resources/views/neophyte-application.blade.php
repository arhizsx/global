...
@section("breadcrumbs")
    <div class="trail"><a href="/">Home</a> > <a href="/triskelions">Triskelions</a> > <strong>Neophyte Application</strong></div>
@endsection
...
<form class="form ajax_form" id="neophyte_application">
    <div class="container-fluid bg-black text-white p-0 m-0">
        ...
        <div class="row py-5 border-bottom">
            <div class="col-xl-3 mb-3 ps-4">
                <h4 class="m-start-4">Health Declaration</h4>
            </div>
            <div class="col-xl-9 mb-3 pe-4 ps-4">
                <div class="fields_box row">
                    <H2>Health Declaration</H2>
                    <p style='line-height: 2; margin-top: 20px;'>&emsp;&emsp;I hereby certify that</p>
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-xl-12 row text-center d-flex justify-content-center align-items-end mb-3" style="min-height: 120px;">
                                <div class="">
                                    <button class="btn btn-dark btn-sm ajax_btn my-3" data-action="affix-signature" data-signbox="health_declaration">Your Signature</button>
                                    <div class="signature_box d-flex d-none justify-content-center w-100"  data-signbox="health_declaration">
                                        <div class="signature" data-signbox="health_declaration"></div>
                                        <textarea class="form-control field_monitor_multi d-none" name="signature[]" data-signbox="health_declaration" data-fieldgroup_name="health_declaration" data-fieldgroup_id="0"></textarea>
                                    </div>
                                </div>
                                <div class="sign-box w-100">Applicant's Name</div>
                            </div>
    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-end px-3 pt-3 pb-5">
            ...
            <button class="btn btn-secondary ajax_btn" data-action="triskelion-registration-continue" data-next_page="/triskelions/triskelion-registration/step-2">Submit Application</button>
        </div>
    </div>
</form>
