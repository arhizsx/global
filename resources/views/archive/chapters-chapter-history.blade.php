...
<form class="form ajax_form" id="chapter_history">
    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-end px-3 pt-3 pb-5">
            <button class="btn btn-dark ajax_btn me-3" data-action="chapter-history-cancel">Cancel</button>
            <button class="btn btn-secondary ajax_btn" data-action="chapter-history-continue">Submit My Registration</button>
        </div>
    </div>
</form>
