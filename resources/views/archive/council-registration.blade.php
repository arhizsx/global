...
<form class="form ajax_form" id="council_registration">
    <div class="container-fluid bg-black text-white">
        ...
        @if($pending_registration)
            <div class="text-center bg-secondary text-white py-2 px-3 d-flex justify-content-between" style="">
                ...
                <div>
                    <button class="btn btn-sm btn-dark ajax_btn" data-action="council-registration-cancel">Clear Entry</button>
                </div>
            </div>
        @endif
    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-end px-3 pt-3 pb-5">
            <button class="btn btn-dark ajax_btn me-3" data-action="council-registration-cancel">Cancel</button>
            <button class="btn btn-secondary ajax_btn" data-action="council-registration-continue">Submit My Registration</button>
        </div>
    </div>
</form>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header" style="background-color: #fdd700;">
                    <h5 class="modal-title" id="modallabel">Council Registration</h5>
                </div>
                ...
                <div class="modal-footer">
                    <a button type="button" class="btn btn-sm btn-secondary" href="/councils">Close</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-sm btn-dark ajax_btn" data-action="council-registration-confirm">Confirm</button>
            </div>
        </div>
    </div>
</div>
