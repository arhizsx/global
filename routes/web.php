...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/councils/registration', function () {
        return view('council-registration');
    });
    ...
    Route::get('/record-update/council/registered', function () {
        return view('record-update-council-registered');
    });

    Route::get('/record-update/council/details', function () {
        return view('record-update-council-details');
    });


    Route::get('/record-update/council', function () {
        return view('record-update-council');
    });
