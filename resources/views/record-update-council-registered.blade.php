...
@section("subheader")
    <div class="subheader-text">Registered Council</div>
@endsection
@section("breadcrumbs")
<div class="trail"><a href="/">Home</a> > <a href="/record-update">Record Update</a> > <a href="/record-update/council">Council</a> > <strong>Registered</strong></div>
@endsection
